...
if "conversation_retrieval_memory_irish" not in st.session_state:
    st.session_state.conversation_retrieval_memory_irish = ConversationBufferMemory(memory_key="chat_history", input_key="human_input")
...
class CustomDataChatbot:
    ...
    def setup_qa_chain(self, query):
        assistant_response , docs = utils.retrieval_docs_irish(query)
    ...
    def main(self):
        user_query = st.chat_input(placeholder="Ask me about Irish Documents posted on Gov.ie from 27/06/2023 to 27/08/2023!")
        database_documents = "irish_database"
